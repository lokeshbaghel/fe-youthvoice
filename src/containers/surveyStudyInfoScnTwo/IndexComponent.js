...
class Profile extends React.Component {
  ...
  setOptionsFunction = () => {
    ...
    return options.map((option, index) => {
      return (
        <>
          <li onChange={this.onChangeValue} className={ index === 0 ? 'active': 'disabled' } >
            ...
            <div className="container" data-aos="fade-up">
              ...
              <div className="row">
                <div className="col-lg-7 col-md-7 mt-5">
                  ...
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey/info/screen/${ id }/${ questionnaireId }/${ questionaireUserRespondentId }/${ type }`)}} > Previous </a>
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey/info/click/${ id }/${ questionnaireId }/${ questionaireUserRespondentId }/${ type }`)}} >Next </a>
                </div>
