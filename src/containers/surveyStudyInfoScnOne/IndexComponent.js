            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  ...
                  <p>Each statement there are five emojis to choose from. </p>
                  <p>Here is what each smiley means:</p>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-7 col-md-7 mt-5">
                  <div className="reaction-div">
                    <ul>
                      { this.setOptionsFunction() }
                    </ul>
                  </div>
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey/info/${ id }/${ questionnaireId }/${ questionaireUserRespondentId }/${ type }`)}} > Previous </a>
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey/info/option/${ id }/${ questionnaireId }/${ questionaireUserRespondentId }/${ type }`)}} >Next </a>
                </div>
