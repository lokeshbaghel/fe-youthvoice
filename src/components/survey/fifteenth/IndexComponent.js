            ...
            <div className="container" data-aos="fade-up">
              ...
              <div className="row">
                ...
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right mt-5" src={images['bg-graphic13.png']} />
                </div>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row align-items-center footer-content">
              ...
              <div className="col-lg-6 col-md-6 text-right">
                <a className="btn btn-primary mr-4" onClick={()=>{ window.location.href = `${url}/survey/fourteenth`}}>Previous</a>
                <a className="btn btn-primary" onClick={()=>{ window.location.href = `${url}/survey/sixteen`}} >Next</a> 
              </div>
            </div>
          </div>
        </footer>{/* End Footer */}
