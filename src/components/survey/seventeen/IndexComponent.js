            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  <h1>I am really well cared for here</h1>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right" src={images['bg-graphic5.png']} />
                </div>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row align-items-center footer-content">
              ...
              <div className="col-lg-6 col-md-6 text-right">
                <a className="btn btn-primary" onClick={()=>{ window.location.href = `${url}/survey/eighteen`}} >Next</a> 
              </div>
            </div>
          </div>
        </footer>{/* End Footer */}
