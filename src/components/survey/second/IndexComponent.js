            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  ...
                  <p>Secondly, next to each statement there are five emojis to choose from.</p>
              ...
              <div className="row">
                <div className="col-lg-7 col-md-7 mt-5">
                  ...
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey`)}} >Back</a>
                  <a className="btn btn-primary" onClick={()=>{this.loadsurvey(`${url}/survey/third`)}}>Next</a>
                </div>
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right" src={images['bg-graphic2.png']} />
                </div>
              </div>
            </div>
