            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  <h1>i exercise for at least 30 minutes per day</h1>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-7 col-md-7 mt-5">
                  <div className="reaction-div">
                    ...
                    <a className="btn btn-primary"><img src={images['disagree-icon.pngg']} /> Disagree</a>
                    <a className="btn btn-primary"><img src={images['strongly-disagree-icon.png']} /> Strongly disagree</a>
                  </div>
                </div>
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right mt-5" src={images['bg-graphic17.png']} />
                </div>
              </div>
            </div>
          ...
          <div className="container">
            <div className="row align-items-center footer-content">
              ...
              <div className="col-lg-6 col-md-6 text-right">
                <a className="btn btn-primary mr-4" onClick={()=>{ window.location.href = `${url}/survey/eighteen`}}>Previous</a>
                <a className="btn btn-primary" onClick={()=>{ window.location.href = `${url}/survey/twenty`}} >Next</a> 
              </div>
            </div>
          </div>
        </footer>{/* End Footer */}
