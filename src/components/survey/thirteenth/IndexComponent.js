            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  <h1>I am making progress in my learning</h1>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right mt-5" src={images['bg-graphic11.png']} />
                </div>
              </div>
            </div>
        ...
        <footer id="footer">
          <div className="container">
            <div className="row align-items-center footer-content">
              ...
              <a className="btn btn-primary mr-4" onClick={()=>{ window.location.href = `${url}/survey/twelveth`}}>Previous</a>
                <a className="btn btn-primary" onClick={()=>{ window.location.href = `${url}/survey/fourteenth`}} >Next</a> 
              </div>
            </div>
          </div>
        </footer>{/* End Footer */}
