            ...
            <div className="container" data-aos="fade-up">
              <div className="row align-items-center">
                <div className="col-lg-7 col-md-7">
                  <h1>I take part in clubs or events outside of lessons that i enjoy</h1>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-lg-5 col-md-5 text-right">
                  <img className="graphic-right mt-5" src={images['bg-graphic14.png']} />
                </div>
              </div>
            </div>
        ...
        <footer id="footer">
          <div className="container">
            <div className="row align-items-center footer-content">
              ...
              <a className="btn btn-primary mr-4" onClick={()=>{ window.location.href = `${url}/survey/fifteenth`}}>Previous</a>
                <a className="btn btn-primary" onClick={()=>{ window.location.href = `${url}/survey/seventeenth`}} >Next</a> 
              </div>
            </div>
          </div>
        </footer>{/* End Footer */}
